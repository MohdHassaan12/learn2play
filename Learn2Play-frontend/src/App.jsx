...
import SportsDetails from "./views/sportsDetails";
      ...
      <div className="app-wrapper d-flex flex-column min-vh-100">
        ...
        <main className="flex-grow-1">
          <Routes>
            ...
            <Route path="/courses" element={<Courses type="all" />} />
            ...
            <Route path='/sports' element={<Courses type="sports" />} />
            <Route path='/sports-details/:sport?' element={<SportsDetails/>}/>
          </Routes>
        </main>
        <Footer />
