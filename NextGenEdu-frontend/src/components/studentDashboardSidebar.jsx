  ...
  return (
    <div className="sidebar col-lg-3">
      <Link className="text-decoration-none " to="/student/dashboard">
        <div
          className={`list-item text-black d-flex m-3 ms-0 me-0 p-3 rounded-3 align-items-center gap-3 ${location.pathname === "/student" ? "active" : ""
            } ${location.pathname === "/student/dashboard" ? "active" : ""} ${location.pathname === "/student/" ? "active" : ""
            }`}
        >
      ...
      <Link className="text-decoration-none " to="/student/enrolled-courses">
        <div
          className={`list-item text-black d-flex m-3 ms-0 me-0 p-3 rounded-3 align-items-center gap-3 ${location.pathname === "/student/enrolled-courses" ? "active" : ""
            }`}
        >
      ...
      <Link className="text-decoration-none " to="/student/accountDetails">
        <div
          className={`list-item text-black d-flex m-3 ms-0 me-0 p-3 rounded-3 align-items-center gap-3 ${location.pathname === "/student/accountDetails" ? "active" : ""
            }`}
        >
      ...
      <Link className="text-decoration-none " to="/student/wishlist">
        <div
          className={`list-item text-black d-flex m-3 ms-0 me-0 p-3 rounded-3 align-items-center gap-3 ${location.pathname === "/student/wishlist" ? "active" : ""
            }`}
        >
      ...
      <Link className="text-decoration-none " to="/student/reviews">
        <div
          className={`list-item text-black d-flex m-3 ms-0 me-0 p-3 rounded-3 align-items-center gap-3 ${location.pathname === "/student/reviews" ? "active" : ""
            }`}
        >
      ...
      <Link className="text-decoration-none " to="/student/quizAttempt">
        <div
          className={`list-item text-black d-flex m-3 ms-0 me-0 p-3 rounded-3 align-items-center gap-3 ${location.pathname === "/student/quizAttempt" ? "active" : ""
            }`}
        >
      ...
      <Link className="text-decoration-none " to="/student/questionAnswer">
        <div
          className={`list-item text-black d-flex m-3 ms-0 me-0 p-3 rounded-3 align-items-center gap-3 ${location.pathname === "/student/questionAnswer" ? "active" : ""
            }`}
        >
      ...
      <div
        className={`list-item row m-3 ms-0 me-0 p-2 rounded-3 align-items-center ${location.pathname === "/student/#/logout" ? "active" : ""
          }`}
